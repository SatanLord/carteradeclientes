...
class tareasController extends AppController
{
	...
	public function agregar(){
	    if ($_POST){
	        ...
	        if ($tareas->guardar($_POST)){
	            $this->_messages->success('Cliente guardado correctamente', $this->redirect(array("controller"=>"tareas"))
                );
            }
        }
        ...
        $this->_view->titulo = "Agregar Cliente";
    ...
    public function editar($id=null){
        ...
        $this->_view->titulo = "Editar Cliente";
    ...
    public function eliminar($id){
        ...
        if (!empty($registro)){
            ...
            $this->_messages->success('Cliente eliminado correctamente', $this->redirect(array("controller"=>"tareas")));
