...
class categoriasController extends AppController
{
    ...
    public function index()
    {
        ...
        $this->_view->titulo = "Listado de Regimenes";
    ...
    public function agregar(){
        if ($_POST){
            ...
            if ($categorias->guardar($_POST)){
                $this->_messages->success('Regimen guardado correctamente', $this->redirect(array("controller"=>"categorias"))
                );
            }
        }
    ...
    public function eliminar($id){
        ...
        if (!empty($registro)){
            ...
            $this->_messages->success('Regimen eliminado correctamente', $this->redirect(array("controller"=>"categorias")));
        }
    }
}
